...
def HomePageView(request):
	...
	calorie_goal_status = calorie -calories.total_calorie
	over_calorie = 0
	...
	return render(request, 'calorie_app/home.html',context)
'''
#signup page
def RegisterPage(request):
	if request.user.is_authenticated:
		...
		context = {'form':form}
		return render(request,'calorie_app/register.html',context)
...
def LoginPage(request):
	if request.user.is_authenticated:
		...
		context = {}
		return render(request,'calorie_app/login.html',context)
...
def select_food(request):
	...
	return render(request, 'calorie_app/select_food.html',context)
...
def add_food(request):
	...
	return render(request,'calorie_app/add_food.html',context)
...
def delete_food(request,pk):
	...
	return render(request,'calorie_app/delete_food.html',context)
...
def ProfilePage(request):
	...
	return render(request, 'calorie_app/profile.html',context)
